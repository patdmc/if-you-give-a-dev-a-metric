module.exports = {
    ...
    pages: [
        {
            text: 'If you give a dev a metric...',
            page: 1,
            note: 'just show json'
        },
        {
            text: `They're going to want to graph it.`,
            page: 2,
            note: 'then show a simple graph'
        },
        {
            text: `And then, once they graph it, they're going to want to decorate the graph so they can easily see if everything is OK.`,
            page: 3,
        ...
        {
            text: `But after doing this for a while, the dev is going to want to simplify...`,
            page: 5,
